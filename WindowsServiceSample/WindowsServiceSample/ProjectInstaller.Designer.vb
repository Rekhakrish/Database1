<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "To update service login time"
        Me.ServiceInstaller.DisplayName = "WindowService"
        Me.ServiceInstaller.ServiceName = "Windowservice"
